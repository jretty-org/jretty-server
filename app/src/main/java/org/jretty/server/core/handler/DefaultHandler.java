package org.jretty.server.core.handler;
...
public class DefaultHandler extends org.eclipse.jetty.server.handler.DefaultHandler {
    ...
    public void handle(String target, Request baseRequest,
        ...
        writer.write("<HTML>\n<HEAD>\n<TITLE>Welcome to jretty server");
        writer.write("</TITLE>\n<BODY>\n<H2>Welcome to jretty server</H2>\n");
        writer.write("<p>jretty server is running successfully.</p>");
